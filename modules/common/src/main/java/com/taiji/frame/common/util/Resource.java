...
public class Resource extends Object {
	...
	public static void setDefaultClassLoader(ClassLoader defaultClassLoader) {
		Resource.defaultClassLoader = defaultClassLoader;
	}
	 ...
	 * @throws IOException If the resource cannot be found or read
	 */
	public static Reader getResourceAsReader(String resource, String code) throws IOException {
		return new InputStreamReader(getResourceAsStream(resource), code);
	}
